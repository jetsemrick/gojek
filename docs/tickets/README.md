...
| [GOTO-S4](./GOTO-S4-nudge-ui.md) | Nudge UI below Payment Summary (show/hide) | M1b | P1 | Done | US-001/005, REQ-001/003/007/008, AC-001/003/008 |
| [GOTO-S5](./GOTO-S5-bottom-sheet-switcher.md) | Bottom sheet switcher | M1b | P1 | Done | US-002/004, REQ-004/005, AC-004/005/007 |
| [GOTO-S6](./GOTO-S6-confirm-switch.md) | Confirm switch (recalc, hide PLUS, success copy, scroll) | M1c | P1 | In Progress | US-002/003/006, REQ-006, AC-006 |
...
M1b web mock (S4 + S5 Done; S6 thin happy path In Progress): `npm run dev`. S7 supply-drop UI and S8 telemetry sink remain Todo.
