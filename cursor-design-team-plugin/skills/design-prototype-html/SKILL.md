---
name: design-prototype-html
description: Build a mobile-first, self-contained HTML canvas prototype from a design brief or research summary. Use for Phase 2 of the design request workflow or when /design-prototype is invoked.
---
...
- User runs `/design-prototype` or Phase 2 of `/design-request`.
...
4. Suggested feedback format for `/design-iterate`
...
- `/design-prototype Mobile profile settings — list rows, toggle notifications, 390px.`
